...
\subsection{基本信息}
\descript{家庭：东京都千代田区}
\descript{高中：国立梨花女子高中}
\sectionsep

\subsection{学校情况}
\descript{就读学校：东京大学}
\descript{所在专业：信息情报学部}
\descript{所在班级：计科1807}
\sectionsep
...
% % LAOSHUBABY
% \location{GitHub如果有}
% \href{https://github.com/laoshubaby}{\bf laoshubaby}
% \location{邮箱（如果有）}
% \urlstyle{same}\href{mailto:laoshubaby@snc.tect}{laoshubaby@snc.tech}
\sectionsep
